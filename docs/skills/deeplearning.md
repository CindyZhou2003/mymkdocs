...
1. **Sigmoid**，两端饱和函数
   ...
   2. **Tanh** ![image.png](./assets/1709725314557-8451b1a3-64ae-4126-b6ee-c57d37eae75c.png)![image.png](../Courses/assets/1709725383719-55775481-905c-4583-a225-8823a6827840.png)
   饱和定义对于函数 𝑓(𝑥)，若 𝑥 → −∞ 时，其导数 𝑓′(𝑥) → 0，则称其为左饱和．若 𝑥 → +∞ 时，其导数 𝑓′(𝑥) → 0，则称其为右饱和．当同时满足左、右饱和时，就称为两端饱和

1. Hard-Logistic & hard-Tanh 一阶泰勒展开的直线近似
2. **ReLU**(PReLU)

![image.png](../Courses/assets/1709725612997-13ad4348-a7c1-45ae-b72e-f13cbb5ae07e.png)![image.png](../Courses/assets/1709815006287-233d495c-ffe3-4c14-a9e2-7c101d7239e0.png)<br />其中 𝛾𝑖 为 𝑥 ≤ 0 时函数的斜率．因此，PReLU 是非饱和函数．如果 𝛾𝑖 = 0，那么PReLU 就退化为 ReLU

4. **ELU**

![image.png](../Courses/assets/1709815094072-4b37f2f5-6453-4da4-acf4-188bfc33f1b9.png)
...
![image.png](../Courses/assets/1709815228781-0b3008bd-cee3-48d9-a3e8-8a81f47337d4.png)
